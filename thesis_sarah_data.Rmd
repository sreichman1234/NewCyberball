...
# three way int? 
three_way_int <- interact_plot(victim_modelexclusion, pred= xtime, mod2 = x1status, modx = x3context, n.sd = 1, file = "3wayint")


bystander_three_way_int <- interact_plot(bystander_modelexclusion, pred= xtime, mod2 = x1status, modx = x3context, n.sd = 1, file = "bystander_3wayint")
