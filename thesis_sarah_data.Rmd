...
# three way int vic
vic_three_way_int <- interact_plot(victim_modelexclusion, pred= xtime, mod2 = x1status, modx = x3context, n.sd = 1,x.label = "time", y.label = "Proportion of ball throws", main.title	= "Victim")+theme_bw()+
  theme(panel.grid.major=element_blank(),
        panel.grid.minor=element_blank(),
        axis.line=element_line(),
        text=element_text(family='Times'),
...
#apa
interact_plot(bystander_modelexclusion, pred= xtime, mod2 = x1status, modx = x3context, n.sd = 1, x.label = "time", y.label = "Proportion of ball throws", main.title	= "Bystander")+theme_bw()+
  theme(panel.grid.major=element_blank(),
        panel.grid.minor=element_blank(),
        axis.line=element_line(),
        text=element_text(family='Times'),
...
# rel_tension
rel_tension.lmer <- glmer(prop ~ xtime * (x1status + x2status) * x3context + rel_tension_md + (xtime | prolific_id), data = new_excluder_all.df, control = glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
